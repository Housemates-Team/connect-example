                ...
                <div className='flex justify-between mt-10'>
                    <div className='w-4/6'>
                        <div>
                            ...
                            <p className='pt-2'>at <span
                                className='font-bold'>{data.item.property.name}</span>, {data.item.address.city}</p>
                        </div>
                        <div className='mt-10'>
                            <h4 className='text-2xl font-extrabold uppercase'>About the room</h4>
                            <div dangerouslySetInnerHTML={{ __html: data.item.rich_description }} className='pt-5 max-w-[45rem]' />
                        </div>
                        <div className='mt-10'>
                    ...
                    <div className='w-2/6'>
                        <div className='bg-white rounded-lg shadow px-3 py-5'>
                            <p>From <span className='text-2xl font-bold'>{data.item.price_range.min}</span> /week</p>
                            <h4 className='mt-5 text-sm uppercase tracking-wide font-bold'>Available booking
                                periods</h4>
                            {
