            ...
            <div className='max-w-7xl mx-auto py-10 sm:px-6 lg:px-8'>
                <div className='space-y-5 mt-10'>
                    <form className='space-y-10 divide-y divide-gray-900/10' onSubmit={handleSubmit}>
                        <div className='grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-3'>
                            <div className='px-4 sm:px-0'>
                                <h2 className='text-base font-semibold leading-7 text-gray-900'>Resident Details</h2>
                        ...
                        <div className='grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3'>
                            <div className='px-4 sm:px-0'>
                                <h2 className='text-base font-semibold leading-7 text-gray-900'>Emergency / Guarantor
                                    Information</h2>
                                <p className='mt-1 text-sm leading-6 text-gray-600'>Contact information of the person supporting the student. This can be used as emergency or guarantor.</p>
                            </div>
                        ...
                        <div className='grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3'>
                            <div className='px-4 sm:px-0'>
                                <h2 className='text-base font-semibold leading-7 text-gray-900'>Course
                                    Information</h2>
                                <p className='mt-1 text-sm leading-6 text-gray-600'>Please provide course information.</p>
                            </div>
                    ...
                    <div className={"flex justify-end pt-10"}>
                        <PrimaryButton type='submit' className={"py-3 px-8"}>Make a payment</PrimaryButton>
                    </div>
                    </form>
                </div>
            </div>
